...
#undef USE_MCP230xx                           // [I2cDriver22] Enable MCP23008/MCP23017 - Must undef I2C Address in #undef USE_MCP230xx_ADDR below - range 0x20 - 0x27 (+4k7 code)
#undef USE_PCA9685                            // [I2cDriver1] Enable PCA9685 I2C HW PWM Driver - Must define I2C Address in #define USE_PCA9685_ADDR below - range 0x40 - 0x47 (+1k4 code)
...
#undef USE_PCF8574                            // [I2cDriver2] Enable PCF8574 I/O Expander (I2C addresses 0x20 - 0x26 and 0x39 - 0x3F) (+2k1 code)
  #undef USE_PCF8574_MODE2                    // Enable Mode2 virtual relays/buttons/switches (+2k3 code)
  #undef USE_PCF8574_SENSOR                   // Enable Mode1 inputs and outputs in SENSOR message (+0k2 code)
  #undef USE_PCF8574_DISPLAYINPUT             // Enable Mode1 inputs display in Web page (+0k2 code)
  #undef USE_PCF8574_MQTTINPUT                // Enable Mode1 MQTT message & rule process on input change detection : stat/%topic%/PCF8574_INP = {"Time":"2021-03-07T16:19:23+01:00","PCF8574-1_INP":{"D1":1}} (+0k5 code)
#undef USE_AHT1x                              // [I2cDriver43] Enable AHT10/15 humidity and temperature sensor (I2C address 0x38, 0x39) (+0k8 code)
#undef USE_AHT2x                              // [I2cDriver43] Enable AHT20 instead of AHT1x humidity and temperature sensor (I2C address 0x38) (+0k8 code)
...
#undef USE_RC522                              // Add support for MFRC522 13.56Mhz Rfid reader (+6k code)
#undef USE_MCP2515                            // Add support for can bus using MCP2515 (+7k code)
#undef USE_CANSNIFFER                         // Add support for can bus sniffer using MCP2515 (+5k code)
...
#undef USE_HPMA                                 // Add support for Honeywell HPMA115S0 particle concentration sensor
...
#undef USE_AZ7798                               // Add support for AZ-Instrument 7798 CO2 datalogger
#undef USE_GPS                                  // Add support for GPS and NTP Server for becoming Stratus 1 Time Source (+ 3.1kb flash, +132 bytes RAM)
#undef USE_BLE_ESP32                            // (ESP32 only) Add support for native BLE on ESP32 - use new driver
#undef USE_MI_ESP32                             // (ESP32 only) Add support for ESP32 as a BLE-bridge (+9k2 mem, +292k flash)

#undef USE_HRXL                                 // Add support for MaxBotix HRXL-MaxSonar ultrasonic range finders (+0k7)
#undef USE_TASMOTA_CLIENT                       // Add support for Arduino Uno/Pro Mini via serial interface including flashing (+2k3 code, 44 mem)
...
#undef USE_PROJECTOR_CTRL_NEC                 // Use codes for NEC
#undef USE_PROJECTOR_CTRL_OPTOMA              // Use codes for OPTOMA
#undef USE_AS608                                // Add support for AS608 optical and R503 capacitive fingerprint sensor (+3k4 code)
#undef USE_TFMINIPLUS                           // Add support for TFmini Plus (TFmini, TFmini-S) LiDAR modules via UART interface
#undef USE_HRG15                                // Add support for Hydreon RG-15 Solid State Rain sensor (+1k5 code)

#undef USE_TELEINFO                             // Add support for French Energy Provider metering telemetry (+5k2 code, +168 RAM + SmartMeter LinkedList Values RAM)
...
#undef USE_ALECTO_V2                          // Add support for decoding Alecto V2 sensors like ACH2010, WS3000 and DKW2012 using 868MHz RF sensor receiver (+1k7 code)
#undef USE_LIGHT
#undef USE_SDCARD
#undef USE_WS2812
